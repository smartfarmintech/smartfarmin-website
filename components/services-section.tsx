...
export function ServicesSection() {
  return (
    <section className="relative py-20 sm:py-32 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 h-96 w-96 rounded-full bg-emerald-500/10 blur-3xl pointer-events-none transform -translate-y-1/2 -translate-x-1/2" />
      <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-amber-500/10 blur-3xl pointer-events-none" />
