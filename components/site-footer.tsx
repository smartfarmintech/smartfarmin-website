  ...
  return (
    <footer id="about" className="scroll-mt-20 relative border-t border-white/10 bg-gradient-to-b from-background via-background to-slate-900/30">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <span className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-green-600 to-green-700 text-white shadow-lg group-hover:shadow-lg group-hover:shadow-green-600/30 transition-all">
            ...
            <div className="flex gap-4 pt-4">
              <a href="#" className="text-slate-400 hover:text-green-400 transition-colors p-2 hover:bg-white/5 rounded-lg">
              ...
              <ul className="space-y-3">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-slate-400 transition-colors duration-200 hover:text-green-400 hover:translate-x-0.5"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-12 border-t border-white/10 bg-gradient-to-r from-transparent via-green-500/20 to-transparent h-px" />
