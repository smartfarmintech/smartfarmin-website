# Rythu360 - Farmer-Friendly Agriculture Platform

## Overview

Rythu360 is India's most farmer-friendly digital agriculture platform, built with mobile-first design principles. The platform serves farmers with minimal technical knowledge, using:
...
- **UI Components**: shadcn/ui, custom Rythu360 components
