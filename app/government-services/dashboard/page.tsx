...
export default function GovernmentDashboard() {
  const apSchemes = [
    ...
    },
    {
      ...
      desc: "Insurance against crop failures",
      amount: "Variable",
      eligible: true,
    },
    {
      name: "AP Rythu Bandhu",
      desc: "Financial assistance per acre",
      amount: "₹5000/acre",
      eligible: true,
    },
    {
      name: "AP Rythu Barosa",
  ...
  const nationalSchemes = [
    {
      ...
      desc: "Pension scheme for farmers",
      benefit: "₹3000/month pension",
    },
    {
      name: "Soil Health Card Scheme",
      desc: "Free soil testing and analysis",
      benefit: "Free soil card + advice",
    },
  ]
